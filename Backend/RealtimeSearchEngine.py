from googlesearch import search # To perform Google searches from your Python code.
from groq import Groq # For AI-related functionalities.
from json import load, dump # To handle JSON data reading and writing.
