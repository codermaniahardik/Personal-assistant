...
# Function to manage Text-to-Speech with additional responese for long text
def TextToSpeech(Text, func=lambda r=None: True):
    ...
    ] # Initialize the list of predefined responses for cases where the text is too long
